...
export const DISTRACTION_DOMAINS: ReadonlyArray<string> = Object.freeze([
  'youtube.com',
  'm.youtube.com',
  'twitter.com',
  'x.com',
...
export const PRODUCTIVE_DOMAINS: ReadonlyArray<string> = Object.freeze([
  'github.com',
  'gitlab.com',
  'bitbucket.org',
  'stackoverflow.com',
...
export const PRODUCTIVE_APPS: ReadonlyArray<string> = Object.freeze([
  'code',
  'visual studio code',
  'cursor',
  'intellij',
...
export const DISTRACTION_APPS: ReadonlyArray<string> = Object.freeze([
  'discord',
  'slack',
  'whatsapp',
  'telegram',
...
export const TELEMETRY_BATCH = Object.freeze({
...
export const PRODUCTIVITY_WEIGHTS = Object.freeze({
  IDE_ACTIVITY: 0.3,
  GIT_ACTIVITY: 0.3,
  FOCUS_DURATION: 0.2,
...
export const DIFFICULTY_BOUNDS = Object.freeze({
  DIMENSION_MIN: 1,
  DIMENSION_MAX: 10,
  MULTIPLIER_MIN: 0.5,
  MULTIPLIER_MAX: 2.0,
...
export const OFFLINE_GRACE = Object.freeze({
...
export const DEFAULT_DIFFICULTY: Readonly<{
  timePressure: number;
